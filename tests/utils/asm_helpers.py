"""
tests/utils/asm_helpers.py
ASM generation test helper
...
from lgd_tool.lgd_decompiler.core.parsers import (
    P1LiteralParser,
    P2SymbolParser,
    FixedTableParser,
    BytecodeParser,
...
def run_pipeline_to_asm(lgd_path: str) -> tuple:
    """
    run to ASM and avoid unnecessary parts。

    Returns:
        (ctx, asm_path) — LgdAnalysisContext and its .asm path
    """
...
# method match ;Function Name() Begin ... ;Function Name() End
